...
data class Blasting(
    ...
    companion object CREATOR : Parcelable.Creator<Blasting> {
        override fun createFromParcel(parcel: Parcel): Blasting {
            return Blasting(parcel)
        }

        override fun newArray(size: Int): Array<Blasting?> {
